/************************************************************************
*   Package	: mesh
*   $Version: meshtest-1.0-39 [develop] $
...
static const char mesh_c_id[] = "@(#) mesh::mesh.c	$Version: meshtest-1.0-39 [develop] $";
#endif
...
/* xhist instrument FALSE */
    ...
    xhist_version("$Version: meshtest-1.0-39 [develop] $");	/* embed build tag of source		*/
