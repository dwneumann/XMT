/************************************************************************
*   Package	: mesh
*   $Version: meshtest-1.0-47 [develop] $
...
static const char mesh_c_id[] = "@(#) mesh::mesh.c	$Version: meshtest-1.0-47 [develop] $";
#endif
...
/* xhist instrument FALSE */
    ...
    xhist_mapfile("$XhistMap: /home/dean/Documents/XMT/xmt_xhist/test/mesh/src/../test/cMesh.map $");	/* embed name of file map		*/
    xhist_version("$Version: meshtest-1.0-47 [develop] $");	/* embed build tag of source		*/
