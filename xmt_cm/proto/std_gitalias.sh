...
git config alias.gco	'git checkout '			# update working copy of named file from repo
...
git config alias.greset	'git reset '			# unstage named files
git config alias.gunstage	 greset				# synonym for greset
